class Api::TimeslotsController < ApplicationController
	...
	def create
		...
		start_timestamp=Time.at(start_time).to_datetime		# convert start time in Unix timestamp to a regular timestamp for storage in database, may want to do this at the model level if its the default behavior
